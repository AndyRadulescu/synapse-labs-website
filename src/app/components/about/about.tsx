...
function About() {
    return (
        <section id="meet" className="about-section py-24 px-8 md:px-24 bg-white text-black overflow-hidden rounded-t-xl w-full lg:w-7/8">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-24">

                <div className="w-full md:w-5/12 flex justify-center items-center relative py-16 md:py-20 about-image-container">
                    <div
                        className="rotating-border absolute w-72 h-72 md:w-96 md:h-96 border-2 border-dashed border-orange-500/30 rounded-full z-0"
                    ></div>

                    <div
                        className="floating-circle relative w-64 h-64 md:w-80 md:h-80 rounded-full bg-gray-50 shadow-2xl overflow-hidden border-4 border-white flex items-center justify-center group z-10"
                    >
                        <div
                ...
                <div className="w-full md:w-7/12 min-w-0">
                    ...
                    <div className="about-text space-y-6 text-lg text-gray-600 leading-relaxed max-w-xl">
                        <p>
                            ...
                            business logic and high-performance software.
                        </p>
                        <p>
